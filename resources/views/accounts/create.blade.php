                ...
                <form method="post" action="{{ route('accounts.store') }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="description" class="block font-medium text-sm text-gray-700">Account Name</label>
                            ...
                            <label for="description" class="block font-medium text-sm text-gray-700">Account Type</label>
                            <input type="text" name="type" id="type" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('description', '') }}" />
                            @error('Account type')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <label for="description" class="block font-medium text-sm text-gray-700">Account Address</label>
